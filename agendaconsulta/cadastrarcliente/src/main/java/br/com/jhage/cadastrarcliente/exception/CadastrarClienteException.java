package br.com.jhage.cadastrarcliente.exception;
 ...
 * 
 */
public class CadastrarClienteException extends Exception {
	
	private static final long serialVersionUID = 1L;
	private static final String DEFAULT= "ERRRO_ACAO_ABRUPTA";
	
	public Logger inicializarLogger() {
		return LogManager.getLogger(CadastrarClienteException.class);
	}
